...
def compile_conv3d_implicit_8wave_fused_v6b(
    ...
    def conv3d_8wave_fused_v6b_kernel(y: fx.Tensor, x: fx.Tensor, weight: fx.Tensor, bias: fx.Tensor):
    ...
    def launch(y: fx.Tensor, x: fx.Tensor, weight: fx.Tensor, bias: fx.Tensor, stream: fx.Stream = fx.Stream(None)):
        conv3d_8wave_fused_v6b_kernel(y, x, weight, bias).launch(
...
def conv3d_implicit_8wave_fused_v6b(x, weight, bias=None, stride=1, padding=0, splitk=None, stream=None):
    ...
    exe = compile_conv3d_implicit_8wave_fused_v6b(n, c, d, h, w, k, kt, kh, kw, st, sh, sw, pt, ph, pw, has_bias, sk)
